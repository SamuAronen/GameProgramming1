    ...
    class LoadingIndicator : MonoBehaviour
    {
        ...
        private void HandleGameStateChanged(GameStateType obj)
        {
            ...
            _tweeners.Add(DOTween.To(() => _backgroundImage.color, (value) => _backgroundImage.color = value,
                Color.clear,
                0.5f).OnComplete(TweenCompleted));
            _tweeners.Add(
                DOTween.To(() => _indicatorImage.color, (value) => _indicatorImage.color = value, Color.clear, 0.5f));
        }
        ...
        private void HandleGameStateChanging(GameStateType obj)
        {
            ...
            DOTween.To(() => _indicatorImageColor, (value) => _indicatorImage.color = value, _indicatorImageColor, 0.5f);
        }
